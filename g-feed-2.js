...
const OUT_PATH = './public/feed-file-2.xml';
const OUT_GZIP_PATH = './public/feed-file-2.xml.gz'; // optional gzipped output
...
`;
        ...
        await writeAsync(stream, itemXml + '\n');  // Extra \n for blank line between items (optional readability boost)
        lastId = r.id;
        total += 1;
      }
